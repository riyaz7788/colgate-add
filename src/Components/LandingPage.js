  ...
  return (
    <div id='mobilebiewonly'>
      ...
      <div className='colgate'>
        ...
        <div className=''>
          <img className='colbanner' src="/images/colgateimage.png" height="160px" width="100px" />
        </div>
        <div class="d-flex justify-content-start px-5 py-5">
          <button className='align-items-center experience' data-bs-toggle="modal" data-bs-target="#staticBackdrop">
